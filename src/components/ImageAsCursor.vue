...
<template>
  <div
    class="aspect-video absolute hidden md:flex shadow-[#0003] shadow-lg z-40 -translate-1/2 pointer-events-none rounded-[2dvw] overflow-hidden ease-linear transition-all duration-75"
    :class="isOpen ? (isSmall ? 'w-[36dvh]' : 'w-[42dvh]') : 'w-0'" :style="`left: ${x}px; top: ${y}px`">
